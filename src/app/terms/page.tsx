        ...
        <div className="min-h-screen flex flex-col">
            ...
            <main className="flex-grow pt-32 px-6 md:px-12 pb-20">
                <FadeIn className="max-w-4xl mx-auto prose dark:prose-invert">
                    ...
                    <p>
                        This document is published in accordance with the provisions of Rule 3 (1) of the Information Technology (Intermediaries guidelines) Rules, 2011 that require publishing the rules and regulations, privacy policy and Terms of Use for access or usage of domain name <strong>ebook-library.com</strong> (“Website”), including the related mobile site and mobile application (hereinafter referred to as “Platform”).
                    </p>
                    <p>
                        The Platform is owned by <strong>Ebook Library Inc.</strong>, a company incorporated under the Companies Act, 1956 with its registered office at <strong>123 Library Lane, Booktown</strong> (hereinafter referred to as "Platform Owner", "we", "us", "our").
                    </p>
                    <p>
                    ...
                    <ul>
                        ...
                        <li>All disputes arising out of or in connection with these Terms shall be subject to the exclusive jurisdiction of the courts in <strong>Bangalore, Karnataka</strong>.</li>
